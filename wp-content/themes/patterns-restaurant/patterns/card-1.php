...
<h5 class="wp-block-heading"><?php esc_html_e( 'Causa Limeña', 'patterns-restaurant' ); ?></h5>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'Patata amarilla, ají amarillo, limón y pollo desmechado con aguacate', 'patterns-restaurant' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
