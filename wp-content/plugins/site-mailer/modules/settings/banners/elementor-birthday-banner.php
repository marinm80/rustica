...
class Elementor_Birthday_Banner {
	const BANNER_POINTER_NAME = 'site_mailer_birthday_sale_banner';
	...
	public static function get_banner( string $link ) {
		...
		?>
		<div class="elementor-birthday-banner" role="region" aria-label="<?php esc_attr_e( 'Elementor birthday sale', 'site-mailer' ); ?>">
			<div class="elementor-birthday-banner-container">
				<p><span><?php esc_html_e( 'Celebrate Elementor’s 10th birthday', 'site-mailer' ); ?></span> | <?php esc_html_e( 'Up to 30% off', 'site-mailer' ); ?></p>
				<a href="<?php echo esc_url( $link ); ?>" target="_blank"><?php esc_html_e( 'Get discounts', 'site-mailer' ); ?></a>
			</div>
			<button type="button" aria-label="<?php esc_attr_e( 'Dismiss', 'site-mailer' ); ?>">
